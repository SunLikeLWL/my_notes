...
// 1、param
// 编码
$.param({name:"sunlike",password:"123"});// name=sunlike&password=123
$.param({name:"sunlike",cname:"阿理旺旺"});// name=sunlike&cname=编码后的值


// 2、decodeURIComponent
// 解码
$.decodeURIComponent($.param({name:"sunlike",password:"123"}));//name=sunlike&password=123

$.decodeURIComponent($.param({name:"sunlike",cname:"阿理旺旺"}));// name=sunlike&cname=阿理旺旺

$.decodeURIComponent($.param({name:"sunlike",arr:[12,3,2]}));//name=sunlike&arr=[12,3,2]
